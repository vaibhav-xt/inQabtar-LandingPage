...
import my_goal from '../assets/my_goal.svg'
                ...
                <div className='w-[95%] xl:w-[89%] m-auto flex justify-between relative gap-4 pt-10'>
                    ...
                    <div className='flex-shrink-0 md:w-[200px] relative border-r border-white border-opacity-20 h-[calc(100vh-140px)] z-10'>
                        <ul className='w-full flex flex-col gap-4 justify-center md:justify-start pr-2'>
                            ...
                            <li className='px-4 py-3 rounded-xl'><a href="/" className='flex gap-2'> <img src={subscription} alt="session" /> <span className='hidden md:block'>My Subscription</span></a></li>
                            <li className='px-4 py-3 rounded-xl'><a href="/" className='flex gap-2'> <img src={session} alt="session" /> <span className='hidden md:block'>My Session</span></a></li>
                            ...
                            <li className='px-4 py-3 rounded-xl'><a href="/" className='flex gap-2'> <img src={progress} alt="progress" /> <span className='hidden md:block'>My Progress</span></a></li>
                            <li className='px-4 py-3 rounded-xl'><a href="/" className='flex gap-2'> <img src={task} alt="tasks" /> <span className='hidden md:block'>My Tasks</span></a></li>
                            <li className='px-4 py-3 rounded-xl'><a href="/" className='flex gap-2'> <img src={my_goal} alt="tasks" /> <span className='hidden md:block'>My Tasks</span></a></li>
                        </ul>
